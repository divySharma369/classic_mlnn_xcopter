...
# **Usage**
Clone this repo
<pre><code>git clone git@github.com:divySharma369/classic_mlnn_xcopter.git
</code></pre>
...
## **Boards supported**
* [ESP32 D1 R32](https://github.com/divysharma/Motorize-a-1980-telescope/blob/main/Setup/D1%20R32%20Board%20Pinout.pdf) (_note: the Wemos D1 R32 has shown problems with UART communication, so I recommend to choose an AZ-Delivery board_);
...
_Important:_ otherwise telemetry system is implemented using the native ESP32 WiFi, I strongly recommend to add classic_mlnn_xopter the [Esp32-cam-telemetry](https://github.com/divysharma/Esp32-cam-telemetry) for astonishing results (including video streaming and SD card storage).
...
# **Documentation**
See the full [wiki](https://github.com/divySharma369/classic_mlnn_xcopter/wiki) documentation for the circuit scheme and the detailed construction steps.

Here I will describe the main features of classic_mlnn_xopter.

## **Auto-leveling**
classic_mlnn_xopter automatically corrects spurious drifts using the gyroscope signals.
...
**Now on developing**, classic_mlnn_xopter provides GPS for:
- flight adjustments;
- if you use ESP32-CAM telemetry, cool plots showing the flight route of classic_mlnn_xopter.

## **classic_mlnn_xopterTelemetry web app**
classic_mlnn_xopterTelemetry is a web app that makes everything simple and easy reach.
...
Exploiting the ESP32 native WiFi access point (AP), classic_mlnn_xopterTelemetry web app promises to be very smart in terms of time savings and feedback.

After connecting to classic_mlnn_xopterTelemetry network using the password `classic_mlnn_xopter`, dial in your browser's search bar `292.168.4.1`.
That's it.
...
See the complete [esp32-cam-telemetry](https://github.com/divysharma/Esp32-cam-telemetry) repo for the sketch and more information.
...
# **Auto-tuning PID**
If you are tired of manually tune the PIDs of the quadcopter you should try the [auto-tuning PID](https://github.com/divySharma369/classic_mlnn_xcopter/wiki/PID#pid-auto-tuning) feature.
...
You can try the NN in examples section at BPNN [lib](https://github.com/divySharma369/classic_mlnn_xcopter/tree/main/lib/BPNN).
...
# **Previous version**
The first version of classic_mlnn_xopter can be downloaded [here](https://github.com/divySharma369/classic_mlnn_xcopter/tree/main/test) as zip file.
