 ...
 *
 * ESP_CAM, connected to classic_mlnn_xopter accordingly to the documentation on GitHub,
 * provides a full telemetry system, a video streaming and the possibility to
 * set PID parameters back to classic_mlnn_xopter.
 *
 * Both uses,
 *  network name "classic_mlnn_xopterTelemetry"
 *  passwork "classic_mlnn_xopter"
 *  server IP "192.168.4.1"
 *
 * After connecting to classic_mlnn_xopterTelemetry network, dial "192.168.4.1" on your
 * browser.
 *
 * @version 0.1
 * @date 2022-03-01
...
const char *index_html() {
  ...
  String indexHTMLHead = R"rawliteral(<!DOCTYPE HTML><html><head>
        <title>classic_mlnn_xopterTelemetry</title>
