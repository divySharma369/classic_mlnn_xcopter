 ...
 *                               DOCUMENTATION:
 * 
 * This is the main file governing classic_mlnn_xopter and contains the architecture of
 ...
 * @brief Main classic_mlnn_xopter file, defining the architecture of the software.
 * @version 1.1
 * @date 2022-03-30 
